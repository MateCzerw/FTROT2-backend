...
VALUES ('LOREM IPSUM', 'DTNA', 3, 4, 1, '2020-11-01', '2021-01-01', TRUE, 1),
       ('LOREM IPSUM', 'HMC', 3, 4, 1, '2020-11-01', '2021-02-01', FALSE, 0),
       ('LOREM IPSUM', 'DAF', 3, 4, 1, '2020-11-01', '2021-03-01', FALSE, 0),
...
INSERT INTO TASK(DESCRIPTION, DURATION, NAME, WORK_PACKAGE_ID, STATUS, ASSIGNED_ENGINEER_ID, DAY_ID)
VALUES ('LOREM IPSUM', 1, 'CAD', 1, 1, 1, 1),
       ('LOREM IPSUM', 1, 'FEM', 1, 1, 1, 2),
       ('LOREM IPSUM', 1, 'DRAWING', 1, 1, 1, 3),
       ('LOREM IPSUM', 1, 'ASSEMBLY', 1, 1, 1, 4),
       ('LOREM IPSUM', 1, 'DFMEA', 1, 1, 1, 5),
       ('LOREM IPSUM', 1, 'CAD', 2, 0.3, 1, 1),
       ('LOREM IPSUM', 1, 'FEM', 2, 0.6, 1, 2),
       ('LOREM IPSUM', 1, 'DRAWING', 2, 0.2, 1, 3),
       ('LOREM IPSUM', 1, 'ASSEMBLY', 2, 0.5, 1, 4),
       ('LOREM IPSUM', 1, 'DFMEA', 2, 0.5, 2, 5),
       ('LOREM IPSUM', 1, 'CAD', 3, 0.5, 2, 6),
       ('LOREM IPSUM', 1, 'FEM', 3, 0.5, NULL , 6),
       ('LOREM IPSUM', 1, 'DRAWING', 3, 0.5, 2, 7),
       ('LOREM IPSUM', 1, 'ASSEMBLY', 3, 0.5, 2, NULL),
       ('LOREM IPSUM', 1, 'DFMEA', 3, 0.5, 2, 8),
       ('LOREM IPSUM', 1, 'CAD', 4, 1, 2, 8),
       ('LOREM IPSUM', 1, 'FEM', 4, 1, 2, 9),
       ('LOREM IPSUM', 1, 'DRAWING', 4, 1, 2, 9),
       ('LOREM IPSUM', 1, 'ASSEMBLY', 4, 1, 2, 10),
       ('LOREM IPSUM', 1, 'DFMEA', 4, 1, 2, 10);
